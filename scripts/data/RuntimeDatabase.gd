...
func _init() -> void:
	...
	cards = [
		...
		{ "id": "subaru-tsukkomi", "name": "吐槽爆擊", "cost": 2, "kind": "attack", "animation": "tsukkomi", "description": "造成 7 點傷害 2 次。", "effects": [{ "type": "damage", "amount": 7, "hits": 2 }] },
		...
		{ "id": "subaru-desk-reaction", "name": "桌面反應", "cost": 1, "kind": "mixed", "animation": "normal_attack", "description": "造成 4 點傷害，獲得 6 點格擋。", "effects": [{ "type": "damage", "amount": 4, "hits": 1 }, { "type": "block", "amount": 6 }] },
		...
		{ "id": "botan-kill-zone", "name": "Kill Zone", "cost": 1, "kind": "support", "animation": "idle", "description": "獲得 5 點格擋。下一張攻擊牌追加 8 點傷害。", "rarity": "common", "floor_band": "early", "archetype_tags": ["two_cost_burst", "fortress_counter"], "role_tags": ["setup", "bridge", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "burst", "upgrade_plan": "升級提高防守與下一槍爆發，讓 Botan 能先架陣再出手。", "upgrade_description": "獲得 7 點格擋。下一張攻擊牌追加 10 點傷害。", "effects": [{ "type": "block", "amount": 5 }, { "type": "next_attack_bonus", "amount": 8 }], "upgrade_effects": [{ "type": "block", "amount": 7 }, { "type": "next_attack_bonus", "amount": 10 }] },
		{ "id": "botan-cover-reload", "name": "掩體換彈", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 9 點格擋。從棄牌堆取回 1 張攻擊牌。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["fortress_counter", "two_cost_burst"], "role_tags": ["defense", "bridge", "utility"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "stability", "upgrade_plan": "升級提高格擋，讓防守回合能穩定回收爆發牌。", "upgrade_description": "獲得 12 點格擋。從棄牌堆取回 1 張攻擊牌。", "effects": [{ "type": "block", "amount": 9 }, { "type": "draw_from_discard", "amount": 1, "kind": "attack" }], "upgrade_effects": [{ "type": "block", "amount": 12 }, { "type": "draw_from_discard", "amount": 1, "kind": "attack" }] },
		...
		{ "id": "azki-pinpoint", "name": "精準標記", "cost": 1, "kind": "mixed", "animation": "map_marker_attack", "description": "給予 1 層標記，造成 4 點傷害。", "effects": [{ "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "damage", "amount": 4, "hits": 1 }] },
		{ "id": "azki-tune-up", "name": "調音", "cost": 0, "kind": "support", "animation": "idle", "description": "抽 1 張牌。", "effects": [{ "type": "draw", "amount": 1 }] },
		{ "id": "azki-kiss", "name": "開拓飛吻", "cost": 2, "kind": "attack", "animation": "kiss_attack", "description": "造成 14 點傷害。若敵人有標記，抽 1 張牌。", "effects": [{ "type": "damage", "amount": 14, "hits": 1 }, { "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }] },
		...
		{ "id": "azki-laplus-crash", "name": "Laplus 墜擊", "cost": 2, "kind": "attack", "animation": "laplus_crash", "description": "造成 18 點傷害，給予 2 回合易傷。若敵人有標記，抽 1 張牌。", "effects": [{ "type": "damage", "amount": 18, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "vulnerable", "amount": 1, "value": 1, "duration": 2 }, { "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }] },
		{ "id": "azki-safe-route", "name": "安全路線", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 7 點格擋。", "effects": [{ "type": "block", "amount": 7 }] },
		{ "id": "azki-coordinate-shield", "name": "座標護盾", "cost": 1, "kind": "mixed", "animation": "defense", "description": "獲得 5 點格擋，給予 1 層標記。", "effects": [{ "type": "block", "amount": 5 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] },
		...
		{ "id": "azki-laplus-cover", "name": "Laplus 掩護", "cost": 1, "kind": "mixed", "animation": "defense", "description": "獲得 6 點格擋，回復 Laplus 2 HP。若敵人有標記，抽 1 張牌。", "effects": [{ "type": "block", "amount": 6 }, { "type": "summon_heal", "amount": 2 }, { "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }] },
		...
		{ "id": "azki-laplus-combo", "name": "Laplus 連攜", "cost": 2, "kind": "attack", "animation": "laplus_dash", "description": "造成 8 點傷害 2 次。若敵人有標記，抽 1 張牌。", "effects": [{ "type": "damage", "amount": 8, "hits": 2 }, { "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }] },
		...
		{ "id": "azki-laplus-reposition", "name": "Laplus 換位", "cost": 1, "kind": "mixed", "animation": "defense", "description": "若敵人有標記，抽 1 張牌。獲得 6 點格擋，給予 1 層標記。", "effects": [{ "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }, { "type": "block", "amount": 6 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] },
		...
		{ "id": "azki-laplus-guard-order", "name": "Laplus 防衛指令", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 6 點格擋，回復 Laplus 3 HP。若 Laplus 存活，抽 1 張牌。", "rarity": "common", "floor_band": "early", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["defense", "utility", "bridge"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高格擋與 summon_heal，讓 Laplus HP 成為可管理的資源。", "upgrade_description": "獲得 8 點格擋，回復 Laplus 4 HP。若 Laplus 存活，抽 1 張牌。", "effects": [{ "type": "block", "amount": 6 }, { "type": "summon_heal", "amount": 3 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "draw", "amount": 1 }] }], "upgrade_effects": [{ "type": "block", "amount": 8 }, { "type": "summon_heal", "amount": 4 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "draw", "amount": 1 }] }] },
		{ "id": "azki-laplus-contract", "name": "Laplus 契約補強", "cost": 1, "kind": "support", "animation": "defense", "description": "回復 Laplus 5 HP，抽 1 張牌。", "rarity": "common", "floor_band": "early", "archetype_tags": ["laplus_guard", "route_explore"], "role_tags": ["bridge", "utility"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高 Laplus HP 疊加量，讓 AZKi 能更早建立召喚獸護盾。", "upgrade_description": "回復 Laplus 7 HP，抽 1 張牌。", "effects": [{ "type": "summon_heal", "amount": 5 }, { "type": "draw", "amount": 1 }], "upgrade_effects": [{ "type": "summon_heal", "amount": 7 }, { "type": "draw", "amount": 1 }] },
		{ "id": "azki-dark-tether", "name": "Dark Tether", "cost": 1, "kind": "mixed", "animation": "map_marker_attack", "description": "造成 5 點傷害，給予 1 層標記，回復 Laplus 4 HP。", "rarity": "common", "floor_band": "early", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["bridge", "setup"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級把攻擊、標記與 Laplus 疊血壓在同一張低費橋接牌上，降低 AZKi 前期斷手感。", "upgrade_description": "造成 7 點傷害，給予 1 層標記，回復 Laplus 5 HP。", "effects": [{ "type": "damage", "amount": 5, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "summon_heal", "amount": 4 }], "upgrade_effects": [{ "type": "damage", "amount": 7, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "summon_heal", "amount": 5 }] },
		...
		{ "id": "azki-laplus-overflow", "name": "Laplus Overflow", "cost": 2, "kind": "attack", "animation": "laplus_crash", "description": "造成 8 點傷害，並追加等同 Laplus HP 的傷害。Exhaust。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["payoff", "scaling"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高基礎傷害，保留 Laplus HP 疊加作為無上限 payoff。", "upgrade_description": "造成 12 點傷害，並追加等同 Laplus HP 的傷害。Exhaust。", "effects": [{ "type": "summon_hp_damage", "base": 8, "per_hp": 1 }], "upgrade_effects": [{ "type": "summon_hp_damage", "base": 12, "per_hp": 1 }] },
		{ "id": "azki-necrobinder-finale", "name": "Necrobinder Finale", "cost": 2, "kind": "attack", "animation": "laplus_crash", "description": "造成 18 點傷害。若 Laplus 存活，額外造成 8 點傷害並回復 Laplus 2 HP。Exhaust。", "rarity": "rare", "floor_band": "late", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["payoff", "risk"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高終結傷害與 Laplus 回復，讓 summon 存活成為明確 payoff。", "upgrade_description": "造成 22 點傷害。若 Laplus 存活，額外造成 10 點傷害並回復 Laplus 3 HP。Exhaust。", "effects": [{ "type": "damage", "amount": 18, "hits": 1 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "damage", "amount": 8, "hits": 1 }, { "type": "summon_heal", "amount": 2 }] }], "upgrade_effects": [{ "type": "damage", "amount": 22, "hits": 1 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "damage", "amount": 10, "hits": 1 }, { "type": "summon_heal", "amount": 3 }] }] },
		{ "id": "azki-phantom-route", "name": "Phantom Route", "cost": 1, "kind": "support", "animation": "map_marker_attack", "description": "建立 1 張臨時 Phantom Marker。回復 Laplus 3 HP。", "rarity": "common", "floor_band": "early", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["setup", "bridge", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "setup", "upgrade_plan": "升級提高臨時標記牌傷害與 Laplus 疊血，讓 setup 同時兼顧安全。", "upgrade_description": "建立 1 張臨時強化 Phantom Marker。回復 Laplus 4 HP。", "effects": [{ "type": "temporary_card", "amount": 1, "card": { "id": "azki-phantom-marker", "name": "Phantom Marker", "cost": 0, "kind": "attack", "animation": "map_marker_attack", "description": "造成 4 點傷害，給予 1 層標記。Temporary。", "effects": [{ "type": "damage", "amount": 4, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] } }, { "type": "summon_heal", "amount": 3 }], "upgrade_effects": [{ "type": "temporary_card", "amount": 1, "card": { "id": "azki-phantom-marker", "name": "Phantom Marker+", "cost": 0, "kind": "attack", "animation": "map_marker_attack", "description": "造成 6 點傷害，給予 1 層標記。Temporary。", "effects": [{ "type": "damage", "amount": 6, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] } }, { "type": "summon_heal", "amount": 4 }] },
		{ "id": "azki-necro-recall", "name": "Necro Recall", "cost": 1, "kind": "support", "animation": "idle", "description": "從棄牌堆取回 1 張 support 牌，回復 Laplus 4 HP。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["bridge", "utility", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "stability", "upgrade_plan": "升級提高 Laplus 疊血，讓回收支援牌時也能穩住 summon 防線。", "upgrade_description": "從棄牌堆取回 1 張 support 牌，回復 Laplus 6 HP。", "effects": [{ "type": "draw_from_discard", "amount": 1, "kind": "support" }, { "type": "summon_heal", "amount": 4 }], "upgrade_effects": [{ "type": "draw_from_discard", "amount": 1, "kind": "support" }, { "type": "summon_heal", "amount": 6 }] },
		{ "id": "azki-laplus-release", "name": "Laplus Release", "cost": 1, "kind": "attack", "animation": "laplus_crash", "description": "造成 8 點傷害。若本場已 Exhaust 至少 2 張牌，追加等同 Laplus HP 的傷害。Exhaust。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["payoff", "scaling", "risk"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "scaling", "upgrade_plan": "升級提高基礎傷害與 Exhaust payoff，讓 Laplus HP 轉成更明確收束。", "upgrade_description": "造成 10 點傷害。若本場已 Exhaust 至少 2 張牌，追加 4 點傷害與等同 Laplus HP 的傷害。Exhaust。", "effects": [{ "type": "damage", "amount": 8, "hits": 1 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 2 }, "effects": [{ "type": "summon_hp_damage", "base": 1, "per_hp": 1 }] }], "upgrade_effects": [{ "type": "damage", "amount": 10, "hits": 1 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 2 }, "effects": [{ "type": "summon_hp_damage", "base": 4, "per_hp": 1 }] }] },
	...
	relics = [
		...
		{ "id": "duck-whistle", "name": "鴨鴨哨子", "description": "每場戰鬥第一次打出 0/1 費牌時，抽 1 張牌並獲得 2 點格擋。", "pool": "common", "source_rules": ["elite", "chest", "shop", "event", "debug"], "hooks": ["first_cheap_card_played"], "hook": "first_cheap_card_played", "cost_max": 1, "effect": "draw", "amount": 1, "effects": [{ "effect": "draw", "amount": 1 }, { "effect": "block", "amount": 2 }] },
		{ "id": "shishiro-crosshair", "name": "獅白準星", "description": "每場戰鬥第一次打出 2 費牌時，額外造成 3 點傷害。", "pool": "elite", "source_rules": ["elite", "chest", "debug"], "hooks": ["first_two_cost_played"], "hook": "first_two_cost_played", "effect": "bonus_damage", "amount": 3 },
		...
		{ "id": "unarchived-archive", "name": "Unarchived Archive", "description": "每場戰鬥第一次打出標記牌時，抽 1 張牌並獲得 1 點能量。", "pool": "boss", "source_rules": ["boss", "chest", "debug"], "hooks": ["first_marker_card_played"], "hook": "first_marker_card_played", "effect": "draw", "amount": 1, "effects": [{ "effect": "draw", "amount": 1 }, { "effect": "energy", "amount": 1 }] },
