...
func _init() -> void:
	...
	cards = [
		...
		{ "id": "subaru-rhythm-guard", "name": "節奏防守", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 9 點格擋。", "effects": [{ "type": "block", "amount": 9 }] },
		...
		{ "id": "subaru-new-oshi-call", "name": "新推號召", "cost": 0, "kind": "support", "animation": "idle", "description": "抽 1 張牌，獲得 6 點格擋。", "effects": [{ "type": "draw", "amount": 1 }, { "type": "block", "amount": 6 }] },
		...
		{ "id": "subaru-crowd-cover", "name": "觀眾掩護", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 9 點格擋。若敵人準備攻擊，抽 1 張牌。Retain。", "rarity": "common", "floor_band": "early", "archetype_tags": ["tempo_block", "cheap_chain"], "role_tags": ["defense", "bridge"], "retain": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高基礎格擋，讓保留牌在攻擊意圖回合更可靠。", "upgrade_description": "獲得 12 點格擋。若敵人準備攻擊，抽 1 張牌。Retain。", "effects": [{ "type": "block", "amount": 9 }, { "type": "conditional", "condition": { "enemy_intents": ["attack", "attack_block"] }, "effects": [{ "type": "draw", "amount": 1 }] }], "upgrade_effects": [{ "type": "block", "amount": 12 }, { "type": "conditional", "condition": { "enemy_intents": ["attack", "attack_block"] }, "effects": [{ "type": "draw", "amount": 1 }] }] },
		...
		{ "id": "subaru-encore-recall", "name": "Encore 回收", "cost": 1, "kind": "support", "animation": "idle", "description": "獲得 6 點格擋。從棄牌堆取回 1 張攻擊牌。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["cheap_chain", "tempo_block"], "role_tags": ["bridge", "utility", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "stability", "upgrade_plan": "升級提高格擋，讓回收攻擊牌時不犧牲太多防守。", "upgrade_description": "獲得 9 點格擋。從棄牌堆取回 1 張攻擊牌。", "effects": [{ "type": "block", "amount": 6 }, { "type": "draw_from_discard", "amount": 1, "kind": "attack" }], "upgrade_effects": [{ "type": "block", "amount": 9 }, { "type": "draw_from_discard", "amount": 1, "kind": "attack" }] },
		{ "id": "subaru-afterimage-table", "name": "殘響拍桌", "cost": 1, "kind": "attack", "animation": "normal_attack", "description": "造成 5 點傷害 2 次。若本場已 Exhaust 至少 1 張牌，獲得 6 點格擋。Exhaust。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["cheap_chain", "multi_hit_strength"], "role_tags": ["payoff", "defense", "risk"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "defense", "upgrade_plan": "升級提高多段傷害與 Exhaust payoff 格擋，讓連段收束更安全。", "upgrade_description": "造成 6 點傷害 2 次。若本場已 Exhaust 至少 1 張牌，獲得 9 點格擋。Exhaust。", "effects": [{ "type": "damage", "amount": 5, "hits": 2 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 1 }, "effects": [{ "type": "block", "amount": 6 }] }], "upgrade_effects": [{ "type": "damage", "amount": 6, "hits": 2 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 1 }, "effects": [{ "type": "block", "amount": 9 }] }] },
		...
		{ "id": "azki-map-shot", "name": "座標彈", "cost": 1, "kind": "attack", "animation": "map_marker_attack", "description": "造成 10 點傷害。", "effects": [{ "type": "damage", "amount": 10, "hits": 1 }] },
		...
		{ "id": "azki-pinpoint", "name": "精準標記", "cost": 1, "kind": "mixed", "animation": "map_marker_attack", "description": "給予 1 層標記，造成 7 點傷害。", "effects": [{ "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "damage", "amount": 7, "hits": 1 }] },
		...
		{ "id": "azki-laplus-dash", "name": "Laplus 衝刺", "cost": 1, "kind": "attack", "animation": "laplus_dash", "description": "造成 10 點傷害，給予 1 層標記。", "effects": [{ "type": "damage", "amount": 10, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] },
		...
		{ "id": "azki-coordinate-barrage", "name": "座標連射", "cost": 1, "kind": "mixed", "animation": "map_marker_attack", "description": "造成 3 點傷害 3 次，給予 1 層標記。", "effects": [{ "type": "damage", "amount": 3, "hits": 3 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] },
		{ "id": "azki-laplus-combo", "name": "Laplus 連攜", "cost": 2, "kind": "attack", "animation": "laplus_dash", "description": "造成 11 點傷害 2 次。若敵人有標記，抽 1 張牌。", "effects": [{ "type": "damage", "amount": 11, "hits": 2 }, { "type": "draw_if_status", "target": "enemy", "status_id": "marker", "amount": 1 }] },
		...
		{ "id": "azki-laplus-overflow", "name": "Laplus Overflow", "cost": 2, "kind": "attack", "animation": "laplus_crash", "description": "造成 14 點傷害，並追加等同 Laplus HP 的傷害。Exhaust。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["payoff", "scaling"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高基礎傷害，保留 Laplus HP 疊加作為無上限 payoff。", "upgrade_description": "造成 18 點傷害，並追加等同 Laplus HP 的傷害。Exhaust。", "effects": [{ "type": "summon_hp_damage", "base": 14, "per_hp": 1 }], "upgrade_effects": [{ "type": "summon_hp_damage", "base": 18, "per_hp": 1 }] },
		{ "id": "azki-necrobinder-finale", "name": "Necrobinder Finale", "cost": 2, "kind": "attack", "animation": "laplus_crash", "description": "造成 24 點傷害。若 Laplus 存活，額外造成 12 點傷害並回復 Laplus 3 HP。Exhaust。", "rarity": "rare", "floor_band": "late", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["payoff", "risk"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高終結傷害與 Laplus 回復，讓 summon 存活成為明確 payoff。", "upgrade_description": "造成 28 點傷害。若 Laplus 存活，額外造成 14 點傷害並回復 Laplus 4 HP。Exhaust。", "effects": [{ "type": "damage", "amount": 24, "hits": 1 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "damage", "amount": 12, "hits": 1 }, { "type": "summon_heal", "amount": 3 }] }], "upgrade_effects": [{ "type": "damage", "amount": 28, "hits": 1 }, { "type": "conditional", "condition": { "summon_alive": true }, "effects": [{ "type": "damage", "amount": 14, "hits": 1 }, { "type": "summon_heal", "amount": 4 }] }] },
		{ "id": "azki-phantom-route", "name": "Phantom Route", "cost": 1, "kind": "support", "animation": "map_marker_attack", "description": "獲得 4 點格擋，建立 1 張臨時 Phantom Marker。回復 Laplus 5 HP。", "rarity": "common", "floor_band": "early", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["setup", "bridge", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "setup", "upgrade_plan": "升級提高臨時標記牌傷害與 Laplus 疊血，讓 setup 同時兼顧安全。", "upgrade_description": "獲得 6 點格擋，建立 1 張臨時強化 Phantom Marker。回復 Laplus 6 HP。", "effects": [{ "type": "block", "amount": 4 }, { "type": "temporary_card", "amount": 1, "card": { "id": "azki-phantom-marker", "name": "Phantom Marker", "cost": 0, "kind": "attack", "animation": "map_marker_attack", "description": "造成 4 點傷害，給予 1 層標記。Temporary。", "effects": [{ "type": "damage", "amount": 4, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] } }, { "type": "summon_heal", "amount": 5 }], "upgrade_effects": [{ "type": "block", "amount": 6 }, { "type": "temporary_card", "amount": 1, "card": { "id": "azki-phantom-marker", "name": "Phantom Marker+", "cost": 0, "kind": "attack", "animation": "map_marker_attack", "description": "造成 6 點傷害，給予 1 層標記。Temporary。", "effects": [{ "type": "damage", "amount": 6, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }] } }, { "type": "summon_heal", "amount": 6 }] },
		{ "id": "azki-necro-recall", "name": "Necro Recall", "cost": 1, "kind": "support", "animation": "idle", "description": "獲得 4 點格擋。從棄牌堆取回 1 張 support 牌，回復 Laplus 6 HP。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["bridge", "utility", "defense"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "stability", "upgrade_plan": "升級提高 Laplus 疊血與格擋，讓回收支援牌時也能穩住 summon 防線。", "upgrade_description": "獲得 6 點格擋。從棄牌堆取回 1 張 support 牌，回復 Laplus 8 HP。", "effects": [{ "type": "block", "amount": 4 }, { "type": "draw_from_discard", "amount": 1, "kind": "support" }, { "type": "summon_heal", "amount": 6 }], "upgrade_effects": [{ "type": "block", "amount": 6 }, { "type": "draw_from_discard", "amount": 1, "kind": "support" }, { "type": "summon_heal", "amount": 8 }] },
		{ "id": "azki-laplus-release", "name": "Laplus Release", "cost": 1, "kind": "attack", "animation": "laplus_crash", "description": "造成 14 點傷害。若本場已 Exhaust 至少 2 張牌，追加 6 點傷害與等同 Laplus HP 的傷害。Exhaust。", "rarity": "uncommon", "floor_band": "mid", "archetype_tags": ["marker_loop", "laplus_guard"], "role_tags": ["payoff", "scaling", "risk"], "exhaust_on_play": true, "art_status": "prototype_placeholder", "art_path": "", "upgrade_signal": "scaling", "upgrade_plan": "升級提高基礎傷害與 Exhaust payoff，讓 Laplus HP 轉成更明確收束。", "upgrade_description": "造成 16 點傷害。若本場已 Exhaust 至少 2 張牌，追加 8 點傷害與等同 Laplus HP 的傷害。Exhaust。", "effects": [{ "type": "damage", "amount": 14, "hits": 1 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 2 }, "effects": [{ "type": "summon_hp_damage", "base": 6, "per_hp": 1 }] }], "upgrade_effects": [{ "type": "damage", "amount": 16, "hits": 1 }, { "type": "conditional", "condition": { "exhaust_count_at_least": 2 }, "effects": [{ "type": "summon_hp_damage", "base": 8, "per_hp": 1 }] }] },
