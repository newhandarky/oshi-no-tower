...
func _init() -> void:
	...
	cards = [
		...
		{ "id": "azki-safe-route", "name": "安全路線", "cost": 1, "kind": "defense", "animation": "defense", "description": "獲得 9 點格擋。", "effects": [{ "type": "block", "amount": 9 }] },
		...
		{ "id": "azki-laplus-contract", "name": "Laplus 契約補強", "cost": 1, "kind": "support", "animation": "defense", "description": "回復 Laplus 7 HP，抽 1 張牌。", "rarity": "common", "floor_band": "early", "archetype_tags": ["laplus_guard", "route_explore"], "role_tags": ["bridge", "utility"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級提高 Laplus HP 疊加量，讓 AZKi 能更早建立召喚獸護盾。", "upgrade_description": "回復 Laplus 9 HP，抽 1 張牌。", "effects": [{ "type": "summon_heal", "amount": 7 }, { "type": "draw", "amount": 1 }], "upgrade_effects": [{ "type": "summon_heal", "amount": 9 }, { "type": "draw", "amount": 1 }] },
		{ "id": "azki-dark-tether", "name": "Dark Tether", "cost": 1, "kind": "mixed", "animation": "map_marker_attack", "description": "造成 6 點傷害，給予 1 層標記，回復 Laplus 5 HP。", "rarity": "common", "floor_band": "early", "archetype_tags": ["laplus_guard", "marker_loop"], "role_tags": ["bridge", "setup"], "art_status": "prototype_placeholder", "art_path": "", "upgrade_plan": "升級把攻擊、標記與 Laplus 疊血壓在同一張低費橋接牌上，降低 AZKi 前期斷手感。", "upgrade_description": "造成 8 點傷害，給予 1 層標記，回復 Laplus 6 HP。", "effects": [{ "type": "damage", "amount": 6, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "summon_heal", "amount": 5 }], "upgrade_effects": [{ "type": "damage", "amount": 8, "hits": 1 }, { "type": "status", "target": "enemy", "status_id": "marker", "amount": 1, "value": 2, "duration": 1 }, { "type": "summon_heal", "amount": 6 }] },
